...
public class HiveSchemaConverter {
  ...
  public static Field getArrowFieldFromHiveType(String name, TypeInfo typeInfo, InputFormat<?, ?> format, boolean includeParquetComplexTypes) {
    ...
    switch (typeInfo.getCategory()) {
      ...
      case LIST: {
        ...
        return new Field(name, new FieldType(true, Types.MinorType.LIST.getType(), null, null),
      ...
      case STRUCT: {
        ...
        return new Field(name, new FieldType(true, Types.MinorType.STRUCT.getType(), null, null),
          structFields);
      }
      case UNION: {
  ...
  public static Field getArrowFieldFromHivePrimitiveType(String name, TypeInfo typeInfo) {
    ...
    case PRIMITIVE:
      ...
      case BYTE:
        return new Field(name, new FieldType(true, new Int(32, true), null, null), null);
      case SHORT:
        return new Field(name, new FieldType(true, new Int(32, true), null, null), null);
      ...
      case LONG:
        return new Field(name, new FieldType(true, new Int(64, true), null, null), null);

      case FLOAT:
        return new Field(name, new FieldType(true, new FloatingPoint(FloatingPointPrecision.SINGLE), null, null), null);

      case DOUBLE:
        return new Field(name, new FieldType(true, new FloatingPoint(FloatingPointPrecision.DOUBLE), null, null), null);

      case DATE:
        return new Field(name, new FieldType(true, new Date(DateUnit.MILLISECOND), null, null), null);

      case TIMESTAMP:
        return new Field(name, new FieldType(true, new Timestamp(TimeUnit.MILLISECOND, null), null, null), null);

      case BINARY:
        return new Field(name, new FieldType(true, new Binary(), null), null);
      case DECIMAL: {
        DecimalTypeInfo decimalTypeInfo = (DecimalTypeInfo) pTypeInfo;
        return new Field(name, new FieldType(true, new Decimal(decimalTypeInfo.getPrecision(), decimalTypeInfo.getScale(), 128), null, null), null);
      }

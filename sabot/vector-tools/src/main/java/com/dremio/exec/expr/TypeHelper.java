...
public class TypeHelper extends BasicTypeHelper {
  ...
  public static Field getFieldForSerializedField(SerializedField serializedField) {
    ...
    case STRUCT: {
      ...
      return new Field(name, new FieldType(true, arrowMinorType.getType(), null, null), builder.build());
    }
    case UNION: {
      ImmutableList.Builder<Field> builder = ImmutableList.builder();
      ...
      return new Field(name, new FieldType(true, unionType, null, null), builder.build());
    }
    case DECIMAL:
      return new Field(name, new FieldType(true,
          new Decimal(serializedField.getMajorType().getPrecision(), serializedField.getMajorType().getScale(), 128), null, null), null);
    default:
      return new Field(name, new FieldType(true, arrowMinorType.getType(), null, null), null);
    }
  }
}

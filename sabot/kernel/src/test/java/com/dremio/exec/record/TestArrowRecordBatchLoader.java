...
public class TestArrowRecordBatchLoader extends DremioTest {
  ...
  public void list() throws InterruptedException {
    try (BufferAllocator allocator = allocatorRule.newAllocator("test-arrow-record-batch-loader", 0, Long.MAX_VALUE); ListVector inVector = new ListVector("input", allocator,  FieldType.nullable(

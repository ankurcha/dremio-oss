...
public class TestByteComparisonFunctions extends ExecTest {
  ...
  public void teardown() {
    hello.buffer.getReferenceManager().release();
    helloLong.buffer.getReferenceManager().release();
    goodbye.buffer.getReferenceManager().release();
    goodbyeLong.buffer.getReferenceManager().release();
  }

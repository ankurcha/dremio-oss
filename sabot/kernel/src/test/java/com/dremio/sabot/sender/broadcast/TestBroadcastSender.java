...
public class TestBroadcastSender extends BaseTestOperator {
  ...
  public BatchSchema getSchema() {
    SchemaBuilder builder = BatchSchema.newBuilder()
      .addField(new Field("n_nationKey", new FieldType(true, MinorType.BIGINT.getType(), null, null), null))
      .addField(new Field("n_name", new FieldType(true, MinorType.VARCHAR.getType(), null, null), null))
      .addField(new Field("n_regionKey", new FieldType(true, MinorType.BIGINT.getType(), null, null), null))
      .addField(new Field("n_comment", new FieldType(true, MinorType.VARCHAR.getType(), null, null), null));

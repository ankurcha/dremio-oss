...
public class DeltaLakeCommitLogScanPrel extends AbstractRelNode implements LeafPrel {
  ...
  private BatchSchema getCommitLogSchema(TableMetadata dataset, List<String> partitionColumnsList) {
    ...
    final Field add = new Field(DELTA_FIELD_ADD, new FieldType(true, new ArrowType.Struct(), null, null),
    ...
    final Field remove = new Field(DELTA_FIELD_REMOVE, new FieldType(true, new ArrowType.Struct(), null, null), ImmutableList.of(removePath, deletionTimestamp, removeDataChange));

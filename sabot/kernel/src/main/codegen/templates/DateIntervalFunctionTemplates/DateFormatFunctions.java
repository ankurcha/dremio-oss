...
@FunctionTemplate(name = "date_format", scope = FunctionTemplate.FunctionScope.SIMPLE, nulls = NullHandling.NULL_IF_NULL)
public class DateFormatFrom${type} implements SimpleFunction {
